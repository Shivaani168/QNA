...
export default class G9ScienceAnswerQs extends Component {
  constructor(props) {
    super(props);
    this.state = {
      answer: '',
 ...
 <ScrollView style={styles.answerContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate('G9ScienceScreen')}>
