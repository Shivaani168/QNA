...
export default class QuestionScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      answered:false,
      question_id:"",
      //question_data:this.props.question.value.route.params.paramKey
...
let questionID = {
    ...
    if (!this.props.route.params) {
      ...
      let images = {
        image_1: require('../assets/biology.jpg'),
        image_2: require('../assets/biology1.jpg'),
        image_3: require('../assets/biology2.jpeg'),
        image_4: require('../assets/biology3.png'),
        image_5: require('../assets/biology4.jpg'),
      };
      return (
        <View
          style={
              ...
              <View style={styles.dataContainer}>
                <View style={styles.titleTextContainer}>
                  ...
                  <Text
                    ...
                    {this.props.route.params.question.answer}
                  </Text>
                </View>
              </View>
