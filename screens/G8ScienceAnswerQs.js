...
export default class G8ScienceAnswerQs extends Component {
  constructor(props) {
    super(props);
    this.state = {
      answer: '',
 ...
 <ScrollView style={styles.answerContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate('G8ScienceScreen')}>
