...
export default class MathsquestionCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontsLoaded: false,
  ...
  render() {
    ...
    if (this.state.fontsLoaded) {
      ...
      let images = {
        image_1: require('../assets/mathematics.jpg'),
        image_2: require('../assets/maths1.webp'),
        image_3: require('../assets/maths2.webp'),
        image_4: require('../assets/maths3.webp'),
        image_5: require('../assets/maths4.jpg'),
      };
      return (
        <TouchableOpacity
          style={styles.container}
          onPress={() =>
            this.props.navigation.navigate('MathsQuestionScreen', {
              question: question,
